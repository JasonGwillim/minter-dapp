...
const CONTRACT_NAME = '_TheDarkClowns_';
...
const GENERIC_DESCRIPTION = "Which Clown will you get?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeiecp5gi6erzeawagorjbttohfij3t6phm6okpuxfc7tgzba5yf5gu"; // Replace with your generic image that will display for all NFTs pre-reveal.
